...
<form action="" method="post">
   ...
   <div class="user-info">
      <h3>your info</h3>
      <p><i class="fas fa-user"><img src="project images/user.png"></i><span><?= $fetch_profile['name'] ?></span></p>
      ...
      <p><i class="fas fa-envelope"><img src="project images/email.png" style="height:23.2px;width:16px;"></i><span><?= $fetch_profile['email'] ?></span></p>
      <a href="update_profile.php" class="btn">update info</a>
      <h3>delivery address</h3>
      <p><i class="fas fa-map-marker-alt"><img src="project images/address.png" style="height:23.2px;width:16px;"></i><span><?php if($fetch_profile['address'] == ''){echo 'please enter your address';}else{echo $fetch_profile['address'];} ?></span></p>
